...
expr<-read.csv(paste0("../../../../../data/norm_RNAseq/",assay_name,"_norm.csv"), header = T, row.names = 1)
...
write.csv(out_int, paste0(assay_name,"_int.csv"))
write.csv(colnames(out_int), paste0(assay_name,"_names.csv"))
