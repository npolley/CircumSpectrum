# RADAR | xCheck (patient cohort implementation)
...
- **Plot 1**: “Significant Reactions Across All Subsystems” – scatter of signed \(-\log_{10}(p)\) by metabolic subsystem, colored by significance or inner comparison.  
